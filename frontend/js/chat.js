    ...
    async function handleSendMessage(e) {
        ...
        try {
            ...
            if (data.images && data.images.length > 0) {
                ...
                const urlPattern = /https:\/\/oaidalleapiprodscus\.blob\.core\.windows\.net\/[^\s\)\]"'<>]+/g;
            ...
            if (imageUrls.length > 0) {
                ...
                cleanedResponse = cleanedResponse.replace(/!\[.*?\]\(https:\/\/oaidalleapiprodscus\.blob\.core\.windows\.net\/[^)]+\)/g, '');
                // Remove URLs soltas
                cleanedResponse = cleanedResponse.replace(/https:\/\/oaidalleapiprodscus\.blob\.core\.windows\.net\/[^\s<>]+/g, '');
